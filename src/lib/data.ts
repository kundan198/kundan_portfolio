...
export const experience = [
  {
    ...
    org: "University of South Florida, SHIELD Lab",
    location: "Tampa, FL",
    period: "Oct 2025 – Present",
    type: "Research",
    signal: "Live neuroscience systems",
    bullets: [
      "Designed and built cross-platform Flutter assessment components for a neurocognitive platform measuring reaction time, memory, attention, and motor performance.",
      "Architected the data models and capture pipeline recording participant interactions and behavioral measurements with research-grade reliability.",
      "Translated open-ended research requirements into structured technical specifications, working directly with the research team to align software design with experimental goals.",
      "Engineered the platform for repeated longitudinal measurement, producing structured datasets ready for downstream statistical analysis.",
    ],
    color: "purple",
  },
  {
    ...
    type: "Industry",
    signal: "Enterprise AI on Azure",
    bullets: [
      "Integrated Azure AI Services, Azure OpenAI, and intelligent chatbot capabilities to automate document classification, improving operational efficiency by 29% across healthcare workflows.",
      "Built React, TypeScript, Redux Toolkit, and Material UI interfaces on Azure App Services, improving responsiveness by 34% and streamlining clinical workflows.",
      "Engineered secure REST APIs and Spring Boot microservices with Hibernate, Azure SQL, Azure Functions, and Service Bus for resilient asynchronous communication.",
      "Established CI/CD with Azure DevOps, Docker, Maven, and Jenkins, and secured access with Spring Security, OAuth 2.0, JWT, and RBAC.",
    ],
    color: "cyan",
  },
  {
    ...
    type: "Industry",
    signal: "Banking platforms at scale",
    bullets: [
      "Developed responsive React, TypeScript, and ASP.NET Core banking applications, improving user engagement by 20% through intuitive digital transaction experiences.",
      "Engineered secure RESTful services with ASP.NET Core and SQL Server supporting reliable, maintainable banking operations.",
      "Integrated AWS EC2, S3, RDS, Lambda, and CloudWatch to support scalable, resilient cloud-hosted financial systems.",
      "Optimized SQL queries, stored procedures, and indexing strategies, improving database execution efficiency by 25% under high-volume transactional workloads.",
    ],
    color: "blue",
  },
];
